    ...
    return {
        getConnection: function getConnection(connectionString, httpAuth) {
            return new Promise(function (resolve, reject) {
                ...
                ElasticSearchConfig.requestTimeout = applicationConstants['elasticReadTimeout'];
                ElasticSearchConfig.deadTimeout = applicationConstants['elasticDeadTimeout'];
        ...
        existEsServer: function existEsServer(connectionString, httpAuth) {
            return new Promise(function (resolve, reject) {
                ...
                EsClient.ping({
                    requestTimeout: applicationConstants['elasticRequestTimeout']
                }, function (error) {
                    if (error) {
                        return reject(error);
                    }
